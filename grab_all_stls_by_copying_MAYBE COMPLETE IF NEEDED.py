...
# this will define the separator as the OS' natural separator,
# and split the path into multiple pieces.
test1 = mainDir.rsplit(os.sep,1)[1]

print("this should also be active_patient:")
print(test1)
